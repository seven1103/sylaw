<template>
        <div class="app-container">
            <div class="filter-container">
                <el-input placeholder="输入标题搜索" style="width:200px"  class="filter-item"></el-input>
            ...
            <el-table v-loading="listLoading" :data="list"  border fit    highlight-current-row style="width: 100%;">
                ...
                <el-table-column label="案例类型" align="center" min-width="100">
                    <template slot-scope="scope">
                        <span>{{ scope.row.cate.name }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="案件律师" align="center" min-width="100" prop="author">
                    <template slot-scope="scope">
                        <span>{{ scope.row.lawyer.name }}</span>
                    </template>
                </el-table-column>
                <el-table-column label="案例标题" align="center" min-width="150" property="title"></el-table-column>
                <el-table-column label="案例内容" align="center" min-width="300" property="content"></el-table-column>
                <el-table-column label="视频图片" align="center" min-width="150">
                    <template slot-scope="scope">
                ...
                <el-table-column label="浏览量" align="center" min-width="80" property="view"></el-table-column>
    ...
    <script>
        import { caseList,delcase } from '@/api/myapi/case'
