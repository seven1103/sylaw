<template>
    ...
    <script>
        import { fetchTemList,addfist,addsed,delfirst,delsed,edit } from '@/api/myapi/classfy'
        ...
        export default{
            ...
            methods:{
                getList(){
                    ...
                    fetchTemList(this.listQuery).then(res=>{
                ...
                add1(form){
                    ...
                    if(ishave) {
                        ...
                        addfist({type:'template',name:form.name}).then(res=>{
                            if(res.data.code==0){
                                Message({
                                    message: '创建成功',
                                    type: 'success',
