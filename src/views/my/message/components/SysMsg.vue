<template>
    <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list"  border fit  highlight-current-row style="width: 100%;" >
            ...
            <el-table-column label="内容" align="center" min-width="300" property="desc"></el-table-column>
            <el-table-column label="封面图片" align="center" min-width="100">
                <template slot-scope="scope">
                    <img width="100%" v-if="scope.row.cover"  :src="scope.row.cover" alt="">
                </template>
            </el-table-column>
             <el-table-column label="时间" align="center" min-width="300" property="desc"></el-table-column>
