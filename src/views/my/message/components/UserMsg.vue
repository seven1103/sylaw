...
<script>
    import { UserMessageList,addMessage,editMessage,delMessage } from '@/api/myapi/message'
    ...
    export default{
        ...
        methods:{
            getList(){
                ...
                UserMessageList(this.listQuery).then(res=>{
            ...
            add(){
                addMessage({title:this.Form.title,cover:'asdad',content:this.Form.content,type:'user'}).then(res=>{
