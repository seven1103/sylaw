<template>
        <div class="app-container">
            <div class="filter-container">
                <el-input placeholder="输入法官账号或电话" style="width:200px"  class="filter-item"></el-input>
    ...
    <script>
        import { judgelist,createjudge,editjudge,deljudge } from '@/api/myapi/account'
        ...
        export default{
            ...
            methods:{
                ...
                add(){
                    ...
                    createjudge(this.Form).then(res=>{
                        this.listLoading = false
                        if(res.data.code==0){
                            Message({
                                message: '创建成功',
                ...
                Delete(row){
                    this.message(()=>{
                        deljudge({admin_id:row._id}).then(res=>{
                            this.listLoading = false
                            if(res.data.code==0){
                                Message({
                                    message: '删除成功',
